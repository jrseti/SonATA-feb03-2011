...
SSE_SETUP=${HOME}/OpenSonATA/sse-pkg/setup
...
SSE_INITRC="${HOME}/OpenSonATA/scripts/sserc-auto.tcl"
export SSE_INITRC
...
envFile="${HOME}/OpenSonATA/scripts/3beam-dualpol-800KHz-72dx-env-vars-batch.sh"
if [ -r ${envFile} ]
then
   . ${envFile}
fi
