...
setenv CHANOPTS "-C 128 -c 25 -N 10 -O 0.25 -B 104.8576 -d $FILTER_DIR/LS256c10f25o70d.flt  -w 5 -F 1420.0 -t -1"
...
${HOME}/OpenSonATA/scripts/switchConfigFile-1beam-800KHz-24dxs.tcsh
