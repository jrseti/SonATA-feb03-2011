...
/**********************************************************************
** $Source: /home/cvs/nss/sonata-pkg/dx/prototype/nss/daddwrite.cc,v $
**
** Task to write DADD data buffers to disk as they fill
**
** $Header: /home/cvs/nss/sonata-pkg/dx/prototype/nss/daddwrite.cc,v 1.1.1.1 2006/08/02 05:30:24 kes Exp $
** $Log: daddwrite.cc,v $
...
** *** empty log message ***
**
Revision 1.3  98/10/29  11:10:35  kes
Changed dadd_write_obs_t to obs_t.

Revision 1.2  98/10/27  08:17:15  kes
...
// function prototypes
void StartDaddObs(nssmsg_t *msg, obs_t *obsInfo, obs_write_t *obs);
void WriteDaddBuf(nssmsg_t *msg, obs_write_t *obs, dadd_info_t *info);

task_t
DaddWriteTask(void *arg)
{
	FUNCTION("DaddWriteTask");
	dadd_info_t info;
	error_t err;
	nssmsg_t *msg;
	obs_t obsInfo;
...
void
StartDaddObs(nssmsg_t *msg, obs_t *obsInfo, obs_write_t *obs)
{
