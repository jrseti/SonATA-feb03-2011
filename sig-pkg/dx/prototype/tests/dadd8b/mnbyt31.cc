...
double (*test1)[NCOLS], (*test2)[NCOLS], (*test3)[NCOLS];
signed char *test11;
signed char *test22;
signed char *test33;
...
int main()
	...
	test1 = new double[NROWSD][NCOLS];
	test2 = new double[NROWSD][NCOLS];
	test3 = new double[NROWSD][NCOLS];

	test11 = (signed char *) test1;
	test22 = (signed char *) test2;
	test33 = (signed char *) test3;
...
//  printf("merged array\n");
//  printarray(NROWS,NCOLS,test33);
    daddshift(1,(long)NROWSD*NCOLS,(double *)test33);
 // printarray(NROWS,NCOLS,test33);
