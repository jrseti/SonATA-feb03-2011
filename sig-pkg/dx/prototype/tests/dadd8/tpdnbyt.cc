...
long long (*test1)[NCOLS], (*test2)[NCOLS], (*test3)[NCOLS];
signed char *test11, *test22, *test33;
...
int main()
	...
	test1 = new long long[NROWSD+1][NCOLS];
	test2 = new long long[NROWSD+1][NCOLS];
	test3 = new long long[NROWSD+1][NCOLS];
	test1 = (long long (*)[NCOLS]) (((unsigned long) test1 + 8) & ~0x7);
	test2 = (long long (*)[NCOLS]) (((unsigned long) test2 + 8) & ~0x7);
	test3 = (long long (*)[NCOLS]) (((unsigned long) test3 + 8) & ~0x7);
	test11 = (char *) test1;
	test22 = (char *) test2;
	test33 = (char *) test3;
...
//    printarray(NROWS,NCOLS,test33);
    ftime(&starttime);
    topdowndadd(log2(NROWS),NCOLS,(char *) &(test1[0][0]));
    ftime(&endtime);
