...
/**********************************************************************
** $Source: /home/cvs/nss/sonata-pkg/dx/prototype/tests/store/write.cc,v $
**
** DADD unpacking
**
** $Header: /home/cvs/nss/sonata-pkg/dx/prototype/tests/store/write.cc,v 1.1.1.1 2006/08/02 05:30:34 kes Exp $
** $Log: write.cc,v $
** Revision 1.1.1.1  2006/08/02 05:30:34  kes
** pdm-1_59
**
** Revision 1.1  2001/11/09 06:03:20  kes
** *** empty log message ***
**
...
main(int argc, char **argv)
{
	...
	lFd0 = open("/dev/rsd2940.2a", O_WRONLY);
	rFd0 = open("/dev/rsd2940.2b", O_WRONLY);
